...
public class PlayWith2Player_UC7
{
    static int SnakeLadderPlayer1Player2(int playerPosition, int count)
    {
        ...
        while (playerPosition != 100)
        {
            ...
            if (a == 1)
            {
                ...
                if (playerPosition > 100)
                {
                    playerPosition =playerPosition - die;
                    System.out.println();
                    System.out.println("The Number Goes more 100");
    ...
    public static void main(String[] args)
    {
        ...
        int player1 = SnakeLadderPlayer1Player2(0, 0);
        {
            System.out.println("Number of Times player1 played: " +player1);
        }

        int player2 = SnakeLadderPlayer1Player2(0, 0);
        {
